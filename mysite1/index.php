...
<body>
  ...
  <div class="conteiner">
		...
		<div class="gallery">
        <ul class="menu">
                  <li><a class="active" href="index.php">Изделия из фетра</a> </li>                   
                           
                  <li><a href="Scrapbooking.php">Скрапбукинг</a></li>
                  <li><a href="Polymerclay.php">Полимерная глина</a></li>
                  <li><a href="Knitwear.php">Вязаные изделия</a> </li>
          </ul>
        <div class="wrapper" >
